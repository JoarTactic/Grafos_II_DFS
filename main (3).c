...
/*
void dfs_traverse( Graph* g, Vertex* v, int* pTiempo)
{
   *pTiempo += 1;
...
void dfs( Graph* g, int start )
{
   ...
   int time_ = 0;
   dfs_traverse( g, Graph_GetVertexByKey( g, start), &time_);
}
*/
//DFS TOPOL
